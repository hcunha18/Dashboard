    ...
    <div className="container">
      ...
      <Container sx={{ marginTop: 6 }}>
        ...
        >
          ...
          ressaltar que atualmente há um total de 42 alunos que realizaram o
          ...
          >
            ...
            <Stack sx={{ maxWidth: 600, width: "100%" }}>
              ...
              >
                ...
                com a matrícula cancelada permaneceu no curso. <br />
                Calculado a partir do semestre de ingresso e com o semestre de
                saída, obtivemos este gráfico para sabermos como ocorre a evasão
                do curso. <br /> A partir dele, conseguimos ver que o maior
                número de cancelados evadem do curso sem mesmo cursar um
                período, e outra grande parte evade após cursar o primeiro
                período, mostrando que se não há uma identificação inicial com o
                curso o aluno ingressante desistiu sem mesmo tentar. <br />
                Em conversa com a coordenadora do projeto e os demais envolvidos
                no processo, chegamos a conclusão que, o grande número de
                cancelamentos/evasão no início do curso provém da dificuldade de
          ...
          >
            ...
            <Stack sx={{ maxWidth: 600, width: "100%" }}>
              ...
              >
                ...
                <br />
                <br />
                Abandono(3): Passou do período imposto para término do curso ou
                não realizou matrícula em períodos subsequentes.
                <br />
                <br />
          ...
          >
            ...
            <Stack sx={{ maxWidth: 600, width: "100%" }}>
              ...
              >
                ...
                seja, evadem após não ter exito nas disciplinas cursadas.
                <br />
          ...
          >
            ...
            <Stack sx={{ maxWidth: 600, width: "100%" }}>
              ...
              >
                ...
                correspondem ao gênero masculino.
                <br />
          ...
          >
            ...
            <Stack sx={{ maxWidth: 600, width: "100%" }}>
              ...
              >
                ...
                796,07 horas.
                <br />
                Relacionando aos cancelados obtivemos um total de apenas 5.56%
                alunos acima dessa média, ou seja, os alunos que têm sua
                matrícula cancelada não chegam a ter um maior contato com o
                curso.
                <br />
          ...
          >
            ...
            <Stack sx={{ maxWidth: 600, width: "100%" }}>
              ...
              >
                ...
                obtivemos um índice baixo de alunos acima, sendo ele de 22.22%.
                <br />
          ...
          >
            ...
            <Stack sx={{ maxWidth: 600, width: "100%" }}>
              ...
              >
                ...
                alunos que vieram de escola pública, representando 69.44% dos
                alunos cancelados.
                <br />
